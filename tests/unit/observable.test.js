...
describe('#observable(el)', function() {
  it('should return obj with one on trigger off function when args is el', function() {
    expect(observable({})).to.have.all.keys('on', 'off', 'one', 'trigger')
  })
})
...
describe('#observable trigger event', function() {
...
describe('#observable trigger off event', function() {
...
describe('#observable trigger special event', function() {
